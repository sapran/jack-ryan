# analyst-pack Specification

## Purpose

Defines the harness-neutral analyst pack shipped with the instance — the role
an agent is initialised with, the analytic spine it works by, and the
epistemics a document corpus demands of any claim made from it.
